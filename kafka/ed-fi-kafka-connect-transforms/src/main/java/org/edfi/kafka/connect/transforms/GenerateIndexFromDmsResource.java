...
public class GenerateIndexFromDmsResource<R extends ConnectRecord<R>> implements Transformation<R> {

    private GenerateIndexFromDmsResourceConfig config;

    @Override
    public ConfigDef config() {
        return GenerateIndexFromDmsResourceConfig.config();
    }

    @Override
    public void configure(final Map<String, ?> settings) {
        this.config = new GenerateIndexFromDmsResourceConfig(settings);
    }
