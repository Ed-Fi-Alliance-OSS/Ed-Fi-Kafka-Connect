...
class GenerateIndexFromDmsResourceTest {
    ...
    private GenerateIndexFromDmsResource<SinkRecord> transformation(final String fieldName) {

        final Map<String, String> props = new HashMap<>();
        if (fieldName != null) {
            props.put("field.name", fieldName);
        }
        final GenerateIndexFromDmsResource<SinkRecord> transform = createTransformationObject();
        transform.configure(props);
        return transform;
    }

    protected GenerateIndexFromDmsResource<SinkRecord> createTransformationObject() {
        return new GenerateIndexFromDmsResource<>();
    }
